...
namespace ERPeducation.ViewModels.Modules.AdmissionCampaign.EducationDocuments
{
    public class EducationMasterViewModel :EducationDocumentBase
    {
        ...
        public EducationMasterViewModel(ObservableCollection<EducationDocumentBase> education, ObservableCollection<ISubmitted> submittedDocuments, Action closeWindow)
        {
