...
using ERPeducation.ViewModels.Modules.AdmissionCampaign.Old.Enrollee;
...
namespace ERPeducation.ViewModels.Modules.AdmissionCampaign.Old
{
    ...
    {
        public EnrolleePersonalInfoViewModel epivm { get; set; } //ViewModel Личной информации
        public EnrolleeContactInfoViewModel ecivm { get; set; } //ViewModel Контактной информации
        public EnrolleeEducationViewModel eevm { get; set; } //ViewModel Образования
        public EnrolleeAdmissionViewModel eavm { get; set; } //ViewModel Поступления
